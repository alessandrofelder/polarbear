 ...
 * </p>
 */
@Plugin(type = Command.class, menuPath = "Plugins>Polar Bear>Combine Image Stack (Old)")
public class CombineNImagesOld<T extends RealType<T>> extends ContextCommand {
